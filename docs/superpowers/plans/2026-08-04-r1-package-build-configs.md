...
- Modify: `docs/superpowers/specs/2026-08-04-r1-package-build-configs-design.md` (record the result in §3.3)
...
In §3.3 of `docs/superpowers/specs/2026-08-04-r1-package-build-configs-design.md`, replace the paragraph beginning "One-time empirical check during implementation" with the measured result. If the outputs were identical:
...
```bash
git add docs/superpowers/specs/2026-08-04-r1-package-build-configs-design.md
