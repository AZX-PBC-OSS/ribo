...
`docs/superpowers/specs/2026-07-28-voice-to-text-mvp-design.md`)
...
| `external`                          | deps + peerDeps (automatic), **plus** `/^react($ | \/)/`, `/^react-dom($                                                                                                                                                                                                                                                                          | \/)/` | A bare `"react"` does not match `react/jsx-runtime` and breaks consumer builds (doc 10 §3.1). |
