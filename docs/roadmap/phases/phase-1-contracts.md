...
The plan for the core contracts — the provenance envelope, `Recording`/`Transcript`, `Transcriber`, `ToolAdapter`, `ReviewPresenter` — that every later phase is written against. Phase 1 is complete.
